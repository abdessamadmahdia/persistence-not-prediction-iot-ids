...
| `CROSS_DATASET_summary.csv` | Table 13, Figures 2–3 | UNSW +1.00; TON −27.18; BoT −44.95 | assembled from `confound_NF_*.csv` and `TONIOT_prototype_ladder_10fold.csv` (its BoT attack ratio 99.8 is 99.69 rounded; the manuscript reports 99.7) |
